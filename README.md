...
<p align="center">
This centalised Shopping List App🛍️ is a Full-stack Progressive Web App developed using 99% Python code🐍, I built this app using Pyscript->(for the User Interface) and Flask->(for the backend server).
</p>
